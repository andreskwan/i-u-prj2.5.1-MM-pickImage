...
@objc(IMGLYMainEditorViewControllerOptions) public class DPPMainEditorViewControllerOptions: EditorViewControllerOptions {
...
@objc(IMGLYMainEditorViewControllerOptionsBuilder) public class MainEditorViewControllerOptionsBuilder: EditorViewControllerOptionsBuilder {
    ...
    public override init() {
        ...
        self.title = NSLocalizedString("main-editor.title", tableName: nil, bundle: NSBundle(forClass: DPPImageEditorViewController.self), value: "", comment: "")
    }
}
...
@objc(IMGLYMainEditorViewController) public class DPPImageEditorViewController: EditorViewController {
    ...
    public override var options: DPPMainEditorViewControllerOptions {
...
extension DPPImageEditorViewController: UICollectionViewDataSource {
...
extension DPPImageEditorViewController: UICollectionViewDelegate {
...
extension DPPImageEditorViewController: UINavigationControllerDelegate {
